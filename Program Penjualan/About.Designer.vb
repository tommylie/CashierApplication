...
Partial Class About
    ...
    Private Sub InitializeComponent()
        ...
        Me.LabelProductName.Text = "Program Penjualan"
        ...
        Me.LabelVersion.Text = "Version : 1.00.0b"
        ...
        Me.TextBoxDescription.Text = "Description : (At runtime, the labels' text will be replaced with the application" & _
    "'s assembly information."
        '
        'OKButton
        '
